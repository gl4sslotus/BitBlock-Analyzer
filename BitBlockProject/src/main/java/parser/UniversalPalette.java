 ...
 * Contains all the colors and their code equivalents.
 * "needs to have 1 to 1 mapping"
 * @author Triston Scallan
 *
 */
public final class UniversalPalette implements ColorPalette {
	/**An immutable map that contains all the token-color tuples*/
	...
	/**
	 * Due to this class being a constant, predefined table
	 * the set method will make no changes.
	 * <p>
	 * {@inheritDoc}
	 * @return false, as setColor will never change PALETTE
	 */
	@Override
	...
	/**
	 * Due to this class being a constant, predefined table
	 * the update method will make no changes.
	 * <p>
	 * {@inheritDoc}
	 * @return false, as updateColor will never change PALETTE
	 */
	@Override
